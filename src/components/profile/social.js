...
const Social = (props) => {
  const location = props.data[0] === null ? "Not Available" : props.data[0];
  const blog = props.data[1] === null ? "Not Available" : props.data[1];
    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 pt-6 md:pl-[20rem]">
      <div className="flex flex-row items-center" id="location">
        <svg
          ...
          className="w-[20px] fill-secondary-blue dark:fill-white"
        >
        ...
        <p className="text-sm text-secondary-blue ml-4 dark:text-white">
          {location}
        </p>
      </div>
      <div className="flex flex-row items-center" id="blog">
        <svg
          ...
          width="20"
          xmlns="http://www.w3.org/2000/svg"
          className="fill-secondary-blue dark:fill-white"
        >
          <g>
        ...
        <a
          className="text-sm text-secondary-blue ml-4 dark:text-white hover:underline"
          href={blog}
          target={`_blank`}
        >
          {blog}
