...
const Header = () => {
  return (
    <div className="flex flex-row justify-between">
      <h1 className="font-bold text-2xl dark:text-white">devfinder</h1>
      <div
        className="flex flex-row justify-between items-center hover:cursor-pointer text-secondary-blue hover:text-black hover:fill-black fill-tertiary-blue"
        onClick={changeTheme}
        id="dark"
      >
        <h3 className="font-bold  pr-4">DARK</h3>
        <svg
          width="20"
          height="20"
      ...
      <div
        className="flex-row justify-between items-center hover:cursor-pointer hidden text-white fill-white hover:text-secondary-blue hover:fill-secondary-blue"
        onClick={changeTheme}
        id="light"
      >
        <h3 className="font-bold pr-4">LIGHT</h3>
